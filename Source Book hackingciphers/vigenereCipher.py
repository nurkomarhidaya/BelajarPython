...
def main():
    ...
    #myMessage = """PT Indoguna Utama, Masalah pergudangan hanyalah urusan catat mencatat akan barang masuk dan barang keluar. Kemudian menyusul istilah muskil: Mauk awal keluar awal (firs in firs out)"""
    myMessage = """PL Qzrjgmvm Ioaei, Yonadit dzrycpoigsv toiystmv prmamb xalif aznuifoo aciz pvrsvs avsms poi bszmbb kwtgom. Kwugrdaf uqbtukcx wntatmv huksuz: Hams mkvl cmxivr semz (aija ub aija aio)"""
